...
type ModelTypesSSRCookies<ModelName extends string, Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape, Enums extends Record<string, string>, FlatModel extends Record<string, unknown> = ResolvedModel<Model>> = IndexQueryMethodsFromIR<ModelMeta['secondaryIndexes'], ModelName, Model, Enums> & {
    create: (model: Prettify<CreateModelInput<Model, ModelMeta>>, options?: {
        authMode?: AuthMode;
        authToken?: string;
        headers?: CustomHeaders;
...
type ModelTypesSSRRequest<ModelName extends string, Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape, Enums extends Record<string, string>, FlatModel extends Record<string, unknown> = ResolvedModel<Model>> = IndexQueryMethodsFromIR<ModelMeta['secondaryIndexes'], ModelName, Model, Enums> & {
...
export type ModelTypes<Schema extends Record<any, any>, Context extends ContextType = 'CLIENT', ModelMeta extends Record<any, any> = ExtractModelMeta<Schema>> = {
    [ModelName in Exclude<keyof Schema, keyof CustomOperations<Schema, 'Mutation' | 'Query' | 'Subscription', Context, ModelMeta>>]: ModelName extends string ? Schema[ModelName] extends Record<string, unknown> ? Context extends 'CLIENT' ? ModelTypesClient<ModelName, Schema[ModelName]['type'], ModelMeta[ModelName], ModelMeta['enums']> : Context extends 'COOKIES' ? ModelTypesSSRCookies<ModelName, Schema[ModelName]['type'], ModelMeta[ModelName], ModelMeta['enums']> : Context extends 'REQUEST' ? ModelTypesSSRRequest<ModelName, Schema[ModelName]['type'], ModelMeta[ModelName], ModelMeta['enums']> : never : never : never;
};
